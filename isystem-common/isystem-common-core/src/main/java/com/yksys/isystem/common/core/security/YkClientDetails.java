 ...
 * @description:
 * @author: YuKai Fan
 * @create: 2019-12-17 18:30
 **/
public class YkClientDetails implements ClientDetails, Serializable {
    private static final long serialVersionUID = -896606369611077754L;
    ...
    public YkClientDetails() {
    }

    public YkClientDetails(ClientDetails prototype) {
        this();
    ...
    public YkClientDetails(String clientId, String resourceIds,
    ...
    public boolean equals(Object obj) {
        ...
        YkClientDetails other = (YkClientDetails) obj;
    ...
    public YkClientDetails convertFor(BaseClientDetails baseClientDetails) {
        YkClientDetailsConvert ykClientDetailsConvert = new YkClientDetailsConvert();
        YkClientDetails ykClientDetails = ykClientDetailsConvert.reverse().convert(baseClientDetails);
        return ykClientDetails;
    }

    public static class YkClientDetailsConvert extends Converter<YkClientDetails, BaseClientDetails> {

        @Override
        protected BaseClientDetails doForward(YkClientDetails ykClientDetails) {
            BaseClientDetails baseClientDetails = new BaseClientDetails();
            BeanUtils.copyProperties(ykClientDetails, baseClientDetails);
            return baseClientDetails;
        }

        @Override
        protected YkClientDetails doBackward(BaseClientDetails baseClientDetails) {
            YkClientDetails ykClientDetails = new YkClientDetails();
            BeanUtils.copyProperties(baseClientDetails, ykClientDetails);
            return ykClientDetails;
        }
    }
}